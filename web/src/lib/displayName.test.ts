...
describe("nameError", () => {
    it.each(["Ada", "  Mary   Ann ", "O'Brien-Smith", "J.R.R. Tolkien", "St. John", "Zoë", "李小龙", "ישראל ישראלי"])(
        "accepts %s",
    ...
    it.each([
        ...
        "google。com",
        "10.0.0.1",
    ])("refuses the link %s", (v) => expect(nameError("Name", v, "person")).toMatch(/קישור/));

    it.each(["Ada‮evil", "Ada​", "<b>Ada</b>", "Ź́́́́"])(
        "refuses the characters in %s",
        (v) => expect(nameError("Name", v, "person")).toMatch(/שאינם מורשים/),
    );
