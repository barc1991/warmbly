...
const ROUTE_TITLES: Record<string, string> = {
  ...
  // Auth
  "/auth/login": "התחברות",
  "/auth/login/confirm": "אימות אימייל",
  "/auth/register": "יצירת חשבון",
  "/auth/register/confirm": "אישור אימייל",
  "/auth/reset-password": "איפוס סיסמה",
  "/auth/reset-password/confirm": "הגדרת סיסמה חדשה",
  "/auth/sso": "מתחבר למערכת",

  // Onboarding / workspace selection
  "/onboarding": "ברוכים הבאים",
  "/select-org": "בחירת מרחב עבודה",
  "/invite": "הצטרפות למרחב עבודה",
  "/setup": "הגדרת Warmbly",
  "/oauth/authorize": "אישור הרשאות אפליקציה",
  "/cloud-oauth/done": "תיבת הדואר חוברה",

  // App
  "/app/emails": "תיבות דואר",
  "/app/contacts": "אנשי קשר",
  "/app/contacts/segments": "סגמנטים",
  "/app/contacts/categories": "קטגוריות",
  "/app/contacts/suppressions": "רשימת חסימה",
  "/app/campaigns": "קמפיינים",
  "/app/analytics": "אנליטיקה",
  "/app/deliverability": "דיוור ועבירות",
  "/app/crm/pipelines": "צינורות מכירה",
  ...
  "/app/audit": "יומן פעילות",
  "/app/unibox": "תיבת דואר מאוחדת",

  // Settings
  "/app/settings/profile": "פרופיל אישי",
  "/app/settings/warmbly-cloud": "Warmbly Cloud",
  "/connect": "חיבור",
  "/cli": "אימות CLI",
  "/app/settings/notifications": "התראות",
  "/app/settings/security": "אבטחה",
  "/app/settings/members": "חברי צוות",
  "/app/settings/teams": "צוותים",
  "/app/settings/workspace": "מרחב עבודה",
  "/app/settings/sending": "הגדרות שליחה",
  "/app/settings/tracking": "מעקב אתר",
  "/app/settings/ai": "בינה מלאכותית",
  "/app/settings/ai-skills": "מיומנויות AI",
  "/app/settings/ai-models": "מודלי AI",
  "/app/settings/oauth-slots": "סלוטים של OAuth",
  "/app/settings/billing": "חיוב ומנוי",
  "/app/settings/referral": "תוכנית שותפים",
  "/app/settings/limits": "תוכנית ומגבלות",
  "/app/settings/roles": "תפקידים והרשאות",
  "/app/settings/webhooks": "Webhooks",
  "/app/settings/connections": "חיבורים",
  "/app/settings/data": "נתונים וגיבויים",
...
const PARAM_ROUTES: ReadonlyArray<readonly [RegExp, string]> = [
  [/^\/app\/contacts\/segments\/[^/]+$/, "סגמנט"],
  [/^\/app\/campaigns\/[^/]+\/leads$/, "נמעני קמפיין"],
  [/^\/app\/campaigns\/[^/]+\/preferences$/, "הגדרות קמפיין"],
  [/^\/app\/campaigns\/[^/]+\/schedule$/, "לוח זמנים לקמפיין"],
