...
const ROUTE_TITLES: Record<string, string> = {
  ...
  "/app/settings/warmbly-cloud": "ענן Warmbly",
  "/connect": "חיבור",
  "/cli": "אימות CLI",
