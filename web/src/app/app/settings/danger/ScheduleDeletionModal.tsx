                    ...
                    >
                        ...
                        <div className="flex-1 min-h-0 overflow-y-auto px-4 py-4 space-y-4">
                            ...
                            <div className="rounded-md border border-amber-200 bg-amber-50/70 px-3 py-2 text-[11.5px] text-amber-800 leading-relaxed">
                                נמתין <strong>{graceDays} ימים</strong> לפני
                                הפעלת המחיקה בפועל. תוכל לבטל בכל עת
                                לפני כן מאותו עמוד זה. לאחר מכן, הנתונים
                                יימחקו לצמיתות ולא נוכל לשחזר אותם.
                            </div>

                            <div className="space-y-1.5">
                                <Label>
                                    הקלד{" "}
                                    <code className="font-mono text-[12px] text-slate-900 bg-slate-100 px-1 rounded break-all" dir="ltr">
                                        {confirmationHint}
                                    </code>{" "}
                                    לאישור
                                </Label>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <TextInput
                                    value={reason}
                                    onChange={setReason}
                                    placeholder="כדי שנוכל להשתפר. נשמר ביומן הביקורת."
                                />
                            </div>
                        </div>
