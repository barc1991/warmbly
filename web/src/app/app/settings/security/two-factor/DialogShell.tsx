    ...
    return (
        ...
        >
            <motion.div
                ...
                className={cn(
                    "w-full max-h-[calc(100dvh-2rem)] flex flex-col rounded-lg bg-white border border-slate-200 overflow-hidden text-right",
                    "shadow-[0_24px_48px_-12px_rgba(15,23,42,0.18),0_8px_16px_-8px_rgba(15,23,42,0.1)]",
                    width === "md" ? "max-w-[560px]" : "max-w-[400px]",
                )}
            >
                <div className="h-12 px-4 border-b border-slate-200 flex items-center justify-between gap-2.5 shrink-0">
                    <div className="flex items-center gap-2.5 min-w-0">
                        {icon && (
                            <div className="size-5 rounded bg-slate-100 text-slate-600 flex items-center justify-center shrink-0">
                                {icon}
                            </div>
                        )}
                    ...
                    {onClose && (
                        <button
                            ...
                            onClick={onClose}
                            aria-label="סגור"
                            className="h-7 w-7 rounded-md inline-flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors shrink-0"
                        >
