...
export function MessageBubble({
    ...
    const toLine = summarizeAddresses(recipients) || "נמענים חסויים";
                    ...
                    <div className="flex items-baseline gap-2 min-w-0">
                        {expanded ? (
                            <button
                                ...
                                aria-label={detailsOpen ? "הסתר פרטי הודעה" : "הצג פרטי הודעה"}
                                title={detailsOpen ? "הסתר פרטים" : "הצג פרטים"}
                                className="inline-flex items-baseline gap-2 min-w-0 max-w-full rounded px-1 -mx-1 hover:bg-slate-100 transition-colors text-right"
                            >
                                <span className="text-[12.5px] font-semibold text-slate-900 truncate">
                                    {name}
                                </span>
                                {addr && (
                                    <span className="text-[11px] text-slate-400 truncate" dir="ltr">
                                        {addr}
                                    </span>
                                )}
                            </button>
                ...
                <div className="text-[12.5px] text-slate-600 sm:ps-10">
                    ...
                    <p className="mt-1.5 flex items-center gap-1.5 text-[11.5px] text-amber-700">
                        ...
                        <button
                            ...
                            className="underline underline-offset-2 hover:text-amber-800 me-1"
                        >
                            נסה שוב
                        </button>
                    </p>
