...
export function SelectionBar({
    ...
    return (
        <div
            role="toolbar"
            aria-label="פעולות על בחירה"
            className="fixed bottom-4 left-1/2 -translate-x-1/2 z-30 flex items-center max-w-[calc(100vw-16px)] flex-wrap justify-center md:max-w-none md:flex-nowrap gap-1.5 rounded-md border border-slate-200 bg-white shadow-[0_6px_20px_-4px_rgba(15,23,42,0.12),0_2px_4px_rgba(15,23,42,0.04)] px-2 py-1.5 dir-rtl"
        >
            ...
            {snoozedScope ? (
                ...
                <PopoverMenu side="top" align="center">
                    ...
                    <PopoverMenuContent>
                        <PopoverMenuLabel>
                            השהה {count.toLocaleString()} שיחות עד
                        </PopoverMenuLabel>
