            ...
            <div className="divide-y divide-slate-200/60">
                ...
                <div className="px-5 py-5 space-y-5">
                    ...
                    <FieldShell
                        ...
                        hint={`מוגרלת מחדש עבור כל שליחה, כך שהמרווחים אינם קבועים. כעת ${secondsToLabel(form.gap_min_seconds)} עד ${secondsToLabel(form.gap_max_seconds)}. מחליף את מרווח המינימום של התיבה כאשר פעיל.`}
                    >
                        <PairField
                ...
                <div className="px-5 py-4">
                    <div className="rounded-md border border-sky-100 bg-sky-50/70 px-3 py-2.5 flex gap-2.5">
                        ...
                        <p className="text-[11.5px] text-sky-900/90 leading-relaxed">
                            כל הזמנים כאן הם מקומיים עבור <b dir="ltr">{tz || "UTC"}</b>: אזור הזמן של תיבת דואר זו, או אזור הזמן של סביבת העבודה כאשר לא הוגדר אזור ייחודי. תיבות דואר באזורים אחרים שומרות על שעות עבודה משלהן באותו קמפיין. ניתן לשנות זאת בלשונית 'הגדרות' של תיבה זו. אזור הזמן של סביבת העבודה תחת הגדרות &gt; פרופיל &gt; אזורי זמן מזיז לוח זמנים זה רק כל עוד התיבה מותאמת לסביבת העבודה.
                        </p>
                    </div>
                </div>
