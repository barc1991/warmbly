...
Facebook and Instagram Lead Ads, LinkedIn Lead Gen Forms and TikTok Lead Generation each have an n8n trigger node that fires on a new submission. Connect it to either route above and the ad's answers become a tagged, campaign-enrolled contact that your mailbox follows up with. The follow-up still runs under each mailbox's daily cap and spacing, so a burst of leads queues rather than going out at once.
