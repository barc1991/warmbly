...
- **Active**, including one **waiting for leads**: woken up to schedule the new leads straight away, or after the campaign's [delay before the first email](/guides/campaigns/#delay-before-the-first-email) when it sets one. That delay counts from when each contact entered the campaign, so someone who joins the segment months later still gets the full wait from their own arrival.
