...
// QuestionType names the three primitives this policy uses. The API also has a
...
// Ask sends one state and every question in one call, and retries only the two
